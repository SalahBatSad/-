      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        <div className="space-y-6 text-center lg:text-right">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 pt-4 justify-center lg:justify-start">
            <button className="relative group overflow-hidden rounded-full p-[1px] font-semibold text-sm">
            ...
            <button className="px-8 py-4 rounded-full border border-gray-700 hover:border-[#D4AF37] text-gray-300 hover:text-[#D4AF37] transition-all text-sm font-medium">
